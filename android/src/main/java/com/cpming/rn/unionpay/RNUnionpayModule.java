...
public class RNUnionpayModule extends ReactContextBaseJavaModule implements ActivityEventListener {

    private ReactApplicationContext reactContext;

    public RNUnionpayModule(@Nonnull ReactApplicationContext reactContext) {
        super(reactContext);
